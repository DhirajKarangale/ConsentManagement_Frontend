...
import { uri_alluserconsents } from "../utils/APIs";
...
export default function Consents() {
    ...
    async function loadConsents() {
        const response = await getRequest<Consnet[]>(`${uri_alluserconsents}/${user?.id}`);
...
import { useSelector } from "react-redux";
import { useNavigate } from "react-router-dom";
import { uri_alluserconsents, uri_updateuserConsent, uri_checkuserconsent } from "../utils/APIs";
...
export default function Consents() {
    ...
    return (
        <div className="container">
            <h1 className="text-center fw-bold display-6 mt-3" style={{ fontSize: '2.0rem' }}>Consents<hr /> </h1>
